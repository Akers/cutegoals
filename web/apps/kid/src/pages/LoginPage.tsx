...
import { KidSpinner, EmptyState } from '@/design/components';
  ...
  return (
    <div className="kid-login-wrap">
      <div className="kid-login-card">
        ...
        <h1 className="kid-login-title">输入 PIN</h1>
        <p className="kid-login-subtitle">输入你的 4-6 位家庭 PIN</p>

        <div className="kid-pin-display" aria-label="PIN 输入" aria-live="polite">
          {pin.replace(/./g, '●') || '—'}
        </div>

        {error && (
          <div className="kid-login-error" role="alert">
            {error}
            {isLocked && (
              <div style={{ marginTop: 4, fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace' }}>
        ...
        <div className="kid-pin-grid">
          ...
          <button
            ...
            className="kid-pin-key kid-pin-key--text"
            aria-label="退格"
          >
            ⌫
          </button>
