/**
 * Stable backend error codes (ported from web/packages/shared/src/api/types.ts §5.2)
 * and their user-facing zh-CN message mapping (ported from shared/src/api/errors.ts).
 */
...
/**
 * User-facing message mapping for stable error codes.
 * Unknown codes fall back to UNKNOWN_ERROR_MESSAGE.
 */
