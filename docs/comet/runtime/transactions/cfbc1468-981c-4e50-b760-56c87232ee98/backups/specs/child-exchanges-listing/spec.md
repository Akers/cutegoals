...
- 现有字段（`id, childId, familyId, type, status, costPoints, prizeId, poolId, resultPrizeId, idempotencyKey, fulfilledAt, fulfilledBy, cancelledAt, cancelledBy, createdAt, updatedAt`）保持不变。
