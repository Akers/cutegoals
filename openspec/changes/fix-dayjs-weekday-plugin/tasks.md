...
- [x] 2. 在 `web/src/app.tsx` 顶部添加 `import '@/shared/dayjs'` side-effect
...
- [x] 3. 移除 `web/src/parent/components/TaskCalendar.tsx` 中的局部 `dayjs.extend(weekOfYear)` 与对应插件 import
